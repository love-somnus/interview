...
```
# 13 、docker compose 安装xxl-job 控制台

## 13.1 SQL脚本

脚本地址官网有 https://github.com/xuxueli/xxl-job/blob/master/doc/db/tables_xxl_job.sql

## 13.2 docker-comopose.yml 文件
...
services:
  xxl-job-admin:
    ...
    environment:
      TZ: Asia/Shanghai
      PARAMS: '--spring.datasource.url=jdbc:mysql://192.168.95.18:3306/xxl_job?setUnicode=true&characterEncoding=utf8&useSSL=false&&serverTimezone=Asia/Shanghai --spring.datasource.username=root --spring.datasource.password=123456'
    ports:
      - 80:8080
    networks:
      - shanhy-ci
